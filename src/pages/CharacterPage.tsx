...
const defaultData: CharacterData = {
  sheet: { attributes: {}, abilities: {}, defenses: {}, defenseOther: false, fullDefense: false, essence: 1, defenseBonus: { parry: 0, evasion: 0, soak: 0, hardness: 0 }, languages: [], merits: [], intimacies: [], motes: { current: 0, committed: 0, total: 0 }, health: [], layout: [], charms: [], effects: [], inventory: [] },
  milestones: [],
  notes: '',
  npcs: [],
}
