          ...
          <div className="max-w-2xl space-y-5">
            ...
            <section>
              <div className="flex items-center justify-between mb-1.5">
                ...
                {isOwner && <button onClick={() => setAddingExalt(v => !v)} title={addingExalt ? 'Cancel' : 'Add type'} className="text-stone-500 hover:text-amber-400 transition-colors">{addingExalt ? '✕' : '+'}</button>}
              </div>
